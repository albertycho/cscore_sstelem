...
#include "lru/lru.h"
#include "no/no.h"
#include "basic_btb/return_stack.h"
#include "basic_btb/direct_predictor.h"
#include "basic_btb/indirect_predictor.h"
#include "basic_btb/basic_btb.h"
champsim::configured::generated_environment<0x05899e0703813be6>::generated_environment() :
channels{
...
DRAM{
champsim::chrono::picoseconds{500}, champsim::chrono::picoseconds{1000}, std::size_t{24}, std::size_t{24}, std::size_t{24}, std::size_t{52}, champsim::chrono::microseconds{32000}, {&channels.at(1)}, 64, 64, 1, champsim::data::bytes{8}, 65536, 1024, 1, 8, 4, 8192
},
vmem{
champsim::data::bytes{4096}, 5, champsim::chrono::picoseconds{500*200}, DRAM, 1
},
ptws {
...
auto champsim::configured::generated_environment<0x05899e0703813be6>::cache_view() -> std::vector<std::reference_wrapper<CACHE>>
{
...
auto champsim::configured::generated_environment<0x05899e0703813be6>::ptw_view() -> std::vector<std::reference_wrapper<PageTableWalker>>
{
...
auto champsim::configured::generated_environment<0x05899e0703813be6>::operable_view() -> std::vector<std::reference_wrapper<champsim::operable>>
{
...
auto champsim::configured::generated_environment<0x05899e0703813be6>::dram_view() -> MEMORY_CONTROLLER&
{
  return DRAM;
}
