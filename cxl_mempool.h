...
public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        { "mem_queue_size", "Internal pool memory-controller queue capacity in requests (0 derives from link credit window or defaults to 128)", "0" },
...
private:
    ...
    uint64_t mem_enqueue_failed_ = 0;
