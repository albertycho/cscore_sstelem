...
NUM_POOLS = int(os.environ.get("NUM_REPLICAS", "1"))
POOL_NODE_ID_BASE = int(os.environ.get("POOL_NODE_ID_BASE", "100"))

# Latency/bandwidth (cycles per 64B) for CXL links.
T_CXL = 120
BW_CXL_CYCLES = 25
...
WARM_CACHE_INSTS = int(os.environ.get("WARM_CACHE_INSTS", "200000"))
WARMUP_MAIN_INSTS = int(os.environ.get("WARMUP_MAIN_INSTS", "100000"))
